...
float getValueFromTensorPos_TENSOR_NAME(int r, int g, int b, int a) {
    int sumVal = g + a * channel_TENSOR_NAME
        + b * channel_TENSOR_NAME * width_shape_TENSOR_NAME
        + r * channel_TENSOR_NAME * width_shape_TENSOR_NAME * height_shape_TENSOR_NAME;
    ivec4 oPos = transferFromNHWCtoNCHW(sumVal, channel_TENSOR_NAME, width_shape_TENSOR_NAME,
        height_shape_TENSOR_NAME, total_shape_TENSOR_NAME);
