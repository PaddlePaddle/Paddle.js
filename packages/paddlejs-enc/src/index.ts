...
const loader = (function (exports: any) {
    "use strict";
...
loader.instantiate(fetch("../build/optimized.wasm"), {
    ...
    fetch("http://localhost:3000/model")
        ...
        .then(modelHex => {
            ...
            const modelPtr = __retain(__newString(modelHex));
            const typePtr = __retain(__newString('ctr'));
            console.log('loadModel')
            loadModel(modelPtr, typePtr);
        });
